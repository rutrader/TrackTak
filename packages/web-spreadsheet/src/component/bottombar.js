...
export default class Bottombar {
  constructor(eventEmitter) {
    ...
    this.contextMenu.itemClick = (...args) =>
      eventEmitter.emit(spreadsheetEvents.bottombar.deleteSheet, ...args);
  ...
  renameItem(index, value) {
    ...
    this.eventEmitter.emit(
      spreadsheetEvents.bottombar.updateSheet,
      index,
      value,
    );
  }
  ...
  clickSwap2(item) {
    ...
    this.clickSwap(item);
    this.activeEl.toggle();
    this.eventEmitter.emit(spreadsheetEvents.bottombar.selectSheet, index);
  }
