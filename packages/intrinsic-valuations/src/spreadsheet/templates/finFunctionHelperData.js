...
export const incomeStatementAttributes = getMappedFilteredArrayAttributes(
  incomeStatement,
);

export const balanceSheetAttributes = getMappedFilteredArrayAttributes(
  balanceSheet,
);

export const cashFlowStatementAttributes = getMappedFilteredArrayAttributes(
  cashFlowStatement,
);

export const riskPremiumsAndBetasAttributes = getMappedArrayAttributes(
  riskPremiumsAndBetas,
);
