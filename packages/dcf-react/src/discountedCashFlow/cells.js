...
const cells = {
  ...
  B1: { value: "Base Year" },
  B2: getExpressionProperties("=TT('totalRevenue')"),
  B3: getExpressionProperties("=B4/B2"),
  B4: getExpressionProperties("=TT('operatingIncome')"),
  B5: getExpressionProperties("=TT('pastThreeYearsAverageEffectiveTaxRate')"),
  B6: getExpressionProperties("=IF(B4 > 0, B4 * (1-B5), B4)"),
  B9: getExpressionProperties("=TT('netOperatingLoss')"),
  B16: getExpressionProperties("=TT('investedCapital')"),
  B19: getExpressionProperties("=M8"),
  B20: getExpressionProperties("=M11"),
  B21: getExpressionProperties(`=B19/(B20-TT('riskFreeRate'))`),
  ...
  B29: getExpressionProperties("=TT('minorityInterest')"),
  B30: getExpressionProperties("=TT('cashAndShortTermInvestments')"),
  B31: getExpressionProperties("=TT('nonOperatingAssets')"),
  B32: getExpressionProperties("=B27-B28-B29+B30+B31"),
  B33: getExpressionProperties("=TT('valueOfAllOptionsOutstanding')"),
  B34: getExpressionProperties("=B32-B33"),
  B35: getExpressionProperties("=TT('price')"),
  B36: getExpressionProperties(
    "=IF(B34/TT('sharesOutstanding') < 0, 0, B34/TT('sharesOutstanding'))",
  ),
  B37: getExpressionProperties("=IFERROR((B36-B35)/B36, 0)"),
  C7: getExpressionProperties("=IF(C2 > B2, (C2-B2) / C15, 0)"),
  C11: getExpressionProperties("=TT('totalCostOfCapital')"),
